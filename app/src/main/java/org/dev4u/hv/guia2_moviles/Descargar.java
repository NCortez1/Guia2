...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    private String cambiarNombre = null;

    public Descargar(Context context, TextView estado, ProgressBar progressBar, Button descargar, String nombre) {
    ...
    public Descargar(Context context,TextView estado,ProgressBar progressBar,Button descargar) {
        this.context      = context;
        this.lblEstado    = estado;
        this.btnDescargar = descargar;
        this.progressBar  = progressBar;
